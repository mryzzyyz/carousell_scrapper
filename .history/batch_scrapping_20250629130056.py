...
def parse_listing_fields(result):
    try:
        ...
        if seller_section:
            ...
            rating_span = seller_section.find('p', {"class": "D_lm M_lh D_ln M_li D_lr M_lm D_lu M_lp D_lw M_lr D_l_ M_lv D_bMw M_bIw D_bMx M_bIx D_lI"})
            seller_rating = rating_span.get_text(strip=True) if rating_span else 'Rating not found'

            # Extract the years on Carousell
            years_span = seller_section.find('p', {"class": "D_lm M_lh D_ln M_li D_lr M_lm D_lu M_lp D_lw M_lr D_l_ M_lv D_bMw M_bIw D_bMx M_bIx D_lI"})
