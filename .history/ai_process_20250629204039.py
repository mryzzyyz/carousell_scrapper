...
def ai_filter(data):
    ...
    prompt = f"""
        ...
        For each of the top {targeted_num} deals, return the output **strictly** in this JSON list format:
        ...
        Do NOT explain your answer. Do NOT include any additional text. Only return the list as valid JSON.
    """
    print("asking AI...")
    print(prompt)
