...
def parse_listing_fields(result):
    try:
        ...
        print(seller_rating_elem.text.strip())
        ...
        print(years_elem.text.strip())
        seller_url_elem = soup.find("a", class_="D_biE D_biI D_lk")
        print(seller_url_elem["href"])
        seller_url = "https://www.carousell.sg" + seller_url_elem["href"] if seller_url_elem else ""
    ...
    try:
        ...
        for i in range(0, len(urls), max_concurrent):
            ...
            for url, result in zip(batch, results):
                ...
                listing = {
                    "id": ids[i+j],  # unique id for each listing
